...
abstract class YamlFormExporterBase extends PluginBase implements YamlFormExporterInterface {
   ...
   *   The form element manager.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, LoggerInterface $logger, EntityManagerInterface $entity_manager, YamlFormElementManagerInterface $element_manager) {
