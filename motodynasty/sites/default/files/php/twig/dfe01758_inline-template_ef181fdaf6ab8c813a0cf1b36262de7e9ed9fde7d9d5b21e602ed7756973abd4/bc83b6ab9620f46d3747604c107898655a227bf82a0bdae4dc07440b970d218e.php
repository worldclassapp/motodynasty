...
/* {# inline_template_start #}<div class="gallery_photo">
    <div class="image ng-lightbox">{{ field_image }}</div>
    <div class="gallery_content">
        <div class="title">{{ title }}</div>
        <div class="sub-title">Volleyball </div>
    </div>
</div> */
class __TwigTemplate_287776c7c261fabcf8ab3e3a42bad9a6fbb610fcc1205bfb97936cbf6f9149cd extends Twig_Template
{
